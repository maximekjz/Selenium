...
class Test_Home(BaseTest):
    ...
    def test_change_language_action(self):
        self.homePage = HomePage(self.driver)
        self.homePage.change_language(new_language=TestData.LANGUAGE_FR)
        welcome_title = self.homePage.get_welcome_title()
        expected_title = TestData.EXPECTED_TITLE_FR
        self.homePage.assert_equal(welcome_title, expected_title)
